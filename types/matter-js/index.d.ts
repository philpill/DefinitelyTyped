...
declare namespace Matter {
    ...
    */
    ...
    export class Common {
         ...
         */
        static get(obj, path, begin, end): any;
         ...
         */
        static set(obj, path, val, begin, end): any;
         ...
         */
        static colorToNumber(colorString): number;
         ...
         */
        static indexOf(haystack, needle): number;
         ...
         */
        static chainPathBefore(base, path, func): Function;
         ...
         * @return {function} The chained function that replaced the original
         */
        static chainPathAfter(base, path, func): Function;
    ...
    */
    export class Render {
         ...
         */
        static lookAt(render: Render, objects: any, padding?: Vector, center?: boolean): void;
